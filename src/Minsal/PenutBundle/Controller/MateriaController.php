...
use Minsal\PenutBundle\Entity\Materia;
use Minsal\PenutBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MinsalPenutBundle:Materia')->findAll();
     ...
     * @Method("POST")
     * @Template("MinsalPenutBundle:Materia:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MinsalPenutBundle:Materia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MinsalPenutBundle:Materia:edit.html.twig")
     */
